...
def data16() -> Grid:
    ...
    pipe01 = Pipe(PipeType.L, Direction.D, (0, 1))
    pipe02 = Pipe(PipeType.D, Direction.L, (0, 2))
    pipe03 = Pipe(PipeType.L, Direction.R, (0, 3))

    pipe10 = Pipe(PipeType.D, Direction.D, (1, 0))
    pipe11 = Pipe(PipeType.T, Direction.D, (1, 1))
    pipe12 = Pipe(PipeType.S, Direction.R, (1, 2))
    pipe13 = Pipe(PipeType.T, Direction.R, (1, 3))

    pipe20 = Pipe(PipeType.L, Direction.D, (2, 0))
    pipe21 = Pipe(PipeType.T, Direction.L, (2, 1))
    pipe22 = Pipe(PipeType.S, Direction.R, (2, 2))
    pipe23 = Pipe(PipeType.T, Direction.U, (2, 3))
