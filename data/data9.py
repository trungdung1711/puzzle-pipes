...
def data9() -> Grid:
    ...
    pipe10 = Pipe(PipeType.D, Direction.L, (1, 0))
    pipe11 = Pipe(PipeType.S, Direction.R, (1, 1))
    pipe12 = Pipe(PipeType.T, Direction.R, (1, 2))
    pipe13 = Pipe(PipeType.S, Direction.R, (1, 3))

    pipe20 = Pipe(PipeType.D, Direction.D, (2, 0))
    pipe21 = Pipe(PipeType.S, Direction.L, (2, 1))
    ...
    pipe32 = Pipe(PipeType.T, Direction.U, (3, 2))
