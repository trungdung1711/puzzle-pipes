...
def data20() -> Grid:
    ...
    pipe00 = Pipe(PipeType.D, Direction.U, (0, 0))
    pipe01 = Pipe(PipeType.T, Direction.R, (0, 1))
    pipe02 = Pipe(PipeType.T, Direction.D, (0, 2))
    pipe03 = Pipe(PipeType.D, Direction.U, (0, 3))

    pipe10 = Pipe(PipeType.D, Direction.U, (1, 0))
    pipe11 = Pipe(PipeType.D, Direction.U, (1, 1))
    pipe12 = Pipe(PipeType.S, Direction.U, (1, 2))
    pipe13 = Pipe(PipeType.D, Direction.R, (1, 3))

    pipe20 = Pipe(PipeType.L, Direction.D, (2, 0))
    pipe21 = Pipe(PipeType.L, Direction.D, (2, 1))
    pipe22 = Pipe(PipeType.T, Direction.R, (2, 2))
    pipe23 = Pipe(PipeType.T, Direction.D, (2, 3))

    pipe30 = Pipe(PipeType.D, Direction.D, (3, 0))
    pipe31 = Pipe(PipeType.T, Direction.D, (3, 1))
    pipe32 = Pipe(PipeType.L, Direction.D, (3, 2))
    pipe33 = Pipe(PipeType.D, Direction.D, (3, 3))
