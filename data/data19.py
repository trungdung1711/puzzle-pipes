...
def data19() -> Grid:
    ...
    pipe01 = Pipe(PipeType.D, Direction.R, (0, 1))
    pipe02 = Pipe(PipeType.D, Direction.L, (0, 2))
    pipe03 = Pipe(PipeType.L, Direction.R, (0, 3))

    pipe10 = Pipe(PipeType.T, Direction.R, (1, 0))
    pipe11 = Pipe(PipeType.L, Direction.D, (1, 1))
    pipe12 = Pipe(PipeType.D, Direction.D, (1, 2))
    pipe13 = Pipe(PipeType.S, Direction.U, (1, 3))
