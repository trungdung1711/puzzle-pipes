...
def data4() -> Grid:
    ...
    pipe11 = Pipe(PipeType.L, Direction.U, (1, 1))
    pipe12 = Pipe(PipeType.T, Direction.U, (1, 2))
    pipe13 = Pipe(PipeType.D, Direction.R, (1, 3))

    pipe20 = Pipe(PipeType.L, Direction.U, (2, 0))
    pipe21 = Pipe(PipeType.T, Direction.U, (2, 1))
    pipe22 = Pipe(PipeType.T, Direction.D, (2, 2))
    pipe23 = Pipe(PipeType.L, Direction.D, (2, 3))

    pipe30 = Pipe(PipeType.D, Direction.L, (3, 0))
    pipe31 = Pipe(PipeType.L, Direction.L, (3, 1))
    pipe32 = Pipe(PipeType.D, Direction.L, (3, 2))
