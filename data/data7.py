...
def data7() -> Grid:
    ...
    pipe01 = Pipe(PipeType.S, Direction.D, (0, 1))
    pipe02 = Pipe(PipeType.L, Direction.R, (0, 2))
    pipe03 = Pipe(PipeType.D, Direction.L, (0, 3))

    pipe10 = Pipe(PipeType.D, Direction.U, (1, 0))
    pipe11 = Pipe(PipeType.D, Direction.R, (1, 1))
    pipe12 = Pipe(PipeType.T, Direction.U, (1, 2))
    pipe13 = Pipe(PipeType.S, Direction.R, (1, 3))

    pipe20 = Pipe(PipeType.T, Direction.U, (2, 0))
    ...
    pipe31 = Pipe(PipeType.D, Direction.D, (3, 1))
    pipe32 = Pipe(PipeType.D, Direction.L, (3, 2))
    pipe33 = Pipe(PipeType.L, Direction.R, (3, 3))
