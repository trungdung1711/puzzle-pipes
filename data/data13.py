...
def data13() -> Grid:
    ...
    pipe02 = Pipe(PipeType.L, Direction.L, (0, 2))
    ...
    pipe20 = Pipe(PipeType.S, Direction.U, (2, 0))
    pipe21 = Pipe(PipeType.L, Direction.R, (2, 1))
    pipe22 = Pipe(PipeType.T, Direction.L, (2, 2))
    pipe23 = Pipe(PipeType.D, Direction.R, (2, 3))

    pipe30 = Pipe(PipeType.L, Direction.R, (3, 0))
    pipe31 = Pipe(PipeType.L, Direction.U, (3, 1))
    pipe32 = Pipe(PipeType.L, Direction.U, (3, 2))
    pipe33 = Pipe(PipeType.L, Direction.D, (3, 3))
