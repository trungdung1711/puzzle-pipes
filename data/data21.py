...
def data21() -> Grid:
    ...
    pipe01 = Pipe(PipeType.T, Direction.L, (0, 1))
    pipe02 = Pipe(PipeType.T, Direction.U, (0, 2))
    ...
    pipe20 = Pipe(PipeType.L, Direction.L, (2, 0))
    pipe21 = Pipe(PipeType.L, Direction.D, (2, 1))
    pipe22 = Pipe(PipeType.T, Direction.L, (2, 2))
    pipe23 = Pipe(PipeType.T, Direction.R, (2, 3))

    pipe30 = Pipe(PipeType.D, Direction.D, (3, 0))
    pipe31 = Pipe(PipeType.T, Direction.R, (3, 1))
