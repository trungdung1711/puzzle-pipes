...
from util import output
                    ...
                    #           Uninformed                                           Informed    
                    # BFS           DLS             GBFS1_v0(-)                GBFS1_v1 (1/)                       GBFS2_v0(-)                                 GBFS2_v1_v2(1/a - b)           A* [ negative h(n) -> causing problem]          A* [ g(n) and possitive h(n) inadmissible -> still causing problem [8]
...
# grid7 = data7()     #                                                                                                  OK                                        OK                                   OK [ long time ]                          OK
# grid8 = data8()     # OK            OK              OK                                OK                               OK                                        OK                                   OK                                        OK
