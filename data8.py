...
def data8() -> Grid:
    ...
    pipe00 = Pipe(PipeType.L_SHAPE, Direction.UP, (0, 0))
    pipe01 = Pipe(PipeType.STRAIGHT, Direction.RIGHT, (0, 1))
    pipe02 = Pipe(PipeType.STRAIGHT, Direction.RIGHT, (0, 2))
    pipe03 = Pipe(PipeType.STRAIGHT_DESTINATION, Direction.UP, (0, 3))

    pipe10 = Pipe(PipeType.T_SHAPE, Direction.LEFT, (1, 0))
    pipe11 = Pipe(PipeType.STRAIGHT, Direction.RIGHT, (1, 1))
    pipe12 = Pipe(PipeType.STRAIGHT, Direction.RIGHT, (1, 2))
    pipe13 = Pipe(PipeType.STRAIGHT_DESTINATION, Direction.RIGHT, (1, 3))

    pipe20 = Pipe(PipeType.T_SHAPE, Direction.DOWN, (2, 0))
    pipe21 = Pipe(PipeType.T_SHAPE, Direction.UP, (2, 1))
    pipe22 = Pipe(PipeType.T_SHAPE, Direction.UP, (2, 2))
    ...
    pipe32 = Pipe(PipeType.L_SHAPE, Direction.UP, (3, 2))
